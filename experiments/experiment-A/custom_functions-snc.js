...
function get_pseudorandomized_exposure_list(label, condition, expSet) {
  ...
  if (expSet === 'A') {
    ...
    filenames_CriticalTypical = ["SH2H", "SH4H", "SH6H", "SH8H", "SH10H",
                                "SH12H", "SH14H", "SH16H", "SH18H", "SH20H"];

    filenames_CriticalShifted = ["S2H", "S4H", "S6H", "S8H", "S10H",
                                "S12H", "S14H", "S16H", "S18H", "S20H"];
