...
```{r}
d.test.Exp2 %<>% run_exclusions(c("CISP-2a", "CISP-2b"))
```

### Experiment 2a

```{r results='markup'}
m.Exp2a <- fit_test_model(d.test.Exp2, "CISP-2a")
...
```{r results='markup'}
m.Exp2a.vs.Exp1c <- fit_test_model(data = bind_rows(d.test.Exp1, d.test.Exp2), experiment = c("CISP-1c", "CISP-2a"))
