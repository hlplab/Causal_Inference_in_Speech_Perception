...
```{r results-exp1 main text, fig.width=fig.base_width*2, fig.height=fig.base_height*3, fig.cap="(ref:results-exp1)", out.width="80%"}
p <-
  plot_data(
    d.test,
    experiment = c("CISP-1a", "CISP-1b", "CISP-1c"))
